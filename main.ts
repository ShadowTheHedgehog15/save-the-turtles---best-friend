...
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
let myBrother = sprites.create(img`
    . . . . . . f f f f f f . . . . 
    . . . . f f e e e e f 2 f . . . 
    ...
    . . . . . . . f f f . . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(myBrother)
scroller.scrollBackgroundWithSpeed(-50, 0)
let favoriteSport = game.askForString("What is your favorite sport?", 10)
game.splash("Brisa is favorite...", favoriteSport)
let player_Age = game.askForNumber("How old u?", 2)
game.splash("\"You are", player_Age)
game.splash("Next Year, you will be", player_Age + 1)
babyDinosSaved = 0
let playerGrade = game.askForNumber("What is your grade?", 2)
let maxGrade = 12
...
myBrother.setStayInScreen(true)
game.splash("Ok lets go soccer!")
for (let index = 0; index < 4; index++) {
    game.showLongText("Brisa going to Soccer", DialogLayout.Bottom)
    pause(500)
}
forever(function () {
